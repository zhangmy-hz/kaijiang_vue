  ...
  <div>
    ...
    <el-card
      ...
      >
        ...
        <el-table-column label="链长" width="100px" prop="size" />
        <el-table-column label="风格" width="80px" prop="sku_style" />
        <el-table-column label="客户备注" width="150px" prop="note" />
        <el-table-column label="对单日期" width="150px" prop="end_date" />
        <el-table-column
          label="操作"
          width="130px"
          fixed="right"
